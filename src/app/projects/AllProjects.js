...
const AllProjects = ({title, type, desc}) => {
    ...
    <div className="md:grid md:grid-cols-2"> {(layoutMode=="full") ? <>
        ...
        <div className="col-start-1 col-span-1 hidden sm:block " >
            ...
            <h1 className={` xl:text-6xl md:text-5xl pl-1  font-bold tracking-tight text-gray-900 dark:text-gray-200 ${(scrollY<1)? projectInfo[scrollY].anim : ""}`}>{projectInfo[scrollY].name}</h1>
