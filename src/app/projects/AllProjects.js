...
const AllProjects = ({title, type, desc, desc2}) => {
    ...
    var projectInfo = [
        ...
        },
        {
            ...
            desc2: "I created this tool to automate the online targeting of potential wholesale customers for a business I supported during lockdown. I was able to save over 100+ Hrs of time compared to manually searching Google Maps.",
            link: "#searchmap",
            anim: "projectText2",
            typeOf: "tech"
        },
        {
            name: "Turbine",
            desc: "Constructed models from first principles to optimised the power generated by a water powered turbine. Given a head pressure curve, I found the optimal nozzle geometry, bucket design and gearbox to maximise the system efficeincy.",
        ...
        },
        {
            ...
            desc2: "Developed this project after studying the FE method at university. I wanted to create a graphical user interface to help illustrate how the various matricies required to solve FE problems are created, and to link this to the structure described.",
            link: "#feasandbox",
            anim: "projectText2",
            typeOf: "tech"
        },
        ...
        },
        {
            ...
            desc2: "Increased the accuracy of predictions by increasing the model complexity. I developed a gear-change system in SIMULINK to simulate the impact of gear changes on the transient response - recieved extra credit for this unique approach.",
            link: "#mcf1",
            anim: "projectText2",
            typeOf: "uol"
        },
    ...
    var projectBullets = [
        ...
        {text1: "Analysis driven solution", text2: "Extended project brief to include transient response", text3: "Project recieved a 1st", extLink: "https://searchmap.web.app/"},
